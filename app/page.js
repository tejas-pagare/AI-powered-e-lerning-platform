...
export default function HomePage() {
  const handleLogout = () => {
    // Placeholder: Replace with actual logout logic (e.g., auth.clearSession(), router.push("/login"))
    alert("Logged out!");
  };

  return (
    <div className="min-h-screen bg-white text-gray-900 flex flex-col p-6 relative">
      {/* Logout Button */}
      ...
      <div className="flex flex-col justify-center items-center flex-1">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-5xl">
          <img
            src="https://images.unsplash.com/photo-1677691820099-a6e8040aa077?q=80&w=774&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt="AI Education"
            className="rounded-xl shadow-md w-full h-64 object-cover"
          />
          <img
            src="https://plus.unsplash.com/premium_photo-1663013231623-d266b26fcd9e?q=80&w=870&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
            alt="Online Learning"
            className="rounded-xl shadow-md w-full h-64 object-cover"
          />
          <img
